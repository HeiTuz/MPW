...
|---|---|---|
| 비율 | 컴파일 S3에서만 끝 토큰(네이티브는 문장으로), 그 밖의 표면은 [../compiler.md](../compiler.md) §4의 파라미터 규칙 | `[프리셋: Flash Editorial · 비율 2:3 — UI에서 선택]` 라벨 |
