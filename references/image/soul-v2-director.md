...
**색상 보정(2026-09-06 공식 문서 확인):** 이전 메모의 HEX 실패 주장은 본문 코드 입력과 Soul HEX 기능을 구분하지 않았고, 이 절에 색상별 대조 결과도 남아 있지 않아 보편 규칙으로 유지하지 않는다. 색 제어는 [surface-contracts.md](surface-contracts.md) §4.1, 공식 근거는 같은 문서 §7을 따른다. 본문 HEX의 현재 반영률은 별도 생성 대조 전까지 미확인이다.
