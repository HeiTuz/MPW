# P4 color campaign — 시리즈 양산

**레이아웃 권한:** 모든 컷에 같은 2색 필드·제품 위치·초대형 카피 관계를 반복하고, 컷마다 위트 있는 소품 하나만 바꾼다. 각 독립 컷은 별도 호출이며 기존 1컷 원칙을 따른다.

**컴파일 공식:** `[동일한 캠페인 DNA 문장] + [이 컷의 소품 1개] + [이 컷의 정확 카피]`. DNA에는 제품 외형·용기 바탕색·패턴·타입 위치를 포함한다.
...
**실패 판정:** 소품이 2개 이상으로 늘거나 DNA 문구가 컷마다 바뀌면 시리즈가 아니다. 끝 토큰 `AR 1:1` 또는 `AR 4:5`.
