...
- 이 트리를 제자리에서 편집하지 않는다. 수정은 정본 https://github.com/HeiTuz/MPW 에서 하고 installer로 재설치한다(`npx --yes --allow-git=all --package github:HeiTuz/MPW heituzmpw -- --target codex --force`).
